...
<head>
    ...
    <title>Add Boarding Information - Art Travels</title>
...
<body>
 ...
 <?php include_once('includes/topnav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Boarding Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
           ...
           <div class="panel panel-default">
				 ...
				 if(isset($_GET['id'])){
				 $mrows = Connection::sqlSelect($pdo_connection,"SELECT bp.* FROM board_points bp WHERE bp.id=".$_GET['id']);
									if(count($mrows)>0){
										foreach($mrows as $rows){
											  $busInfo[0]=$rows->id;
												$busInfo[1]=$rows->bus_id;                        
												$busInfo[2]=$rows->board_point; 
												$busInfo[3]=$rows->pickup_point; 
												$busInfo[4]=$rows->pickup_time;                       
				  ...
				  ?>
               <!-- form start -->
			   <form role="form" action="includes/db_addboarding.php?id=<?php echo $busInfo[0];?>" method="post"  class="validate" enctype="multipart/form-data">
                  <div class="box-body">                 
                     <div class="col-md-6">
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control required" name="pickup_point" value="<?php echo $busInfo[3]; ?>"  data-parsley-trigger="change"	
                  ...
                  <div class="box-footer">
				   ...
				   <div class="col-md-6">
	                     ...
	                     <div class="form-group">
                          <label>Route</label>
							<select class="form-control select2 subcat" placeholder="Board point"  style="width: 100%;" name="board_point" id="board_point">
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input type="text"  value="<?php echo $busInfo[4]; ?>" name="pickup_time" id="pickup_time" class="form-control timepicker">
