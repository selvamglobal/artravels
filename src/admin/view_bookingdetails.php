...
<body>
 ...
 <?php include_once('includes/topnav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View Booking Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <th>Action</th>
                                    ...
                                    <tbody>
                                    <?php
									$mrows = Connection::sqlSelect($pdo_connection,"SELECT bp.*,b.bus_reg_no, b.bus_name, b.bus_type, b.board_point, b.board_time FROM board_points bp INNER JOIN bus b ON bp.bus_id=b.id ");
									if(count($mrows)>0){
                           ...
                           <td class="center"><?php echo $rows->bus_type; ?></td>	
                           	 <td class="center"><?php echo $rows->board_point.'<br>(Time: '.$rows->board_time.')'; ?></td>				   
