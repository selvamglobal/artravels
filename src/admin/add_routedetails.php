           ...
           <div class="panel panel-default">
               ...
               <!-- form start -->
			    <form role="form" action="includes/db_addroute.php?id=<?php echo $busInfo[0];?>" method="post"  class="validate" enctype="multipart/form-data">
                     ...
                     <button type="submit" class="btn btn-primary"><?php echo $busInfo[8];?></button>
                  </div>             
                        </div>                   
                   <div class="col-md-6">
				      	...
				      	<div class="form-group has-feedback">
                           ...
                           data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="Fare" value="<?php echo $busInfo[7];?>">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
