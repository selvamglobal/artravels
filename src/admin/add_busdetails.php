			    ...
			    <form role="form" action="includes/db_addbus.php?id=<?php echo $busInfo[0];?>" method="post"  class="validate" enctype="multipart/form-data">
                     ...
                     <div class="col-md-6">
					   ...
					   <div class="form-group">
                        <label>Bus Type</label>
                           ...
                           <option value="<?php echo $busInfo[0];?>"> - <?php echo $busInfo[3];?></option>
                   ...
                   <div class="col-md-6">
				      	...
				      	<div class="form-group has-feedback">
                           ...
                           data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="Bus RegiNumber" value="<?php echo $busInfo[2];?>">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Maximum Seats</label>
                           <input type="text" class="form-control required" name="max_seats" data-parsley-trigger="change" required="" placeholder="Maximum Seats" value="<?php echo $busInfo[4];?>">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>  
