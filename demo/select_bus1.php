                ...
                <div class="ptext">
                    <div class="cover-container pb-5 pt-5 ">
                        <div class="cover-inner container reveal-top">
                            ...
                            <h2 class="jumbotron-heading "> Coimbatore to Chennai - 13-Oct-2017</h1>
                                <div class="row bg-white text-primary text-left ">
                                    <div class="col-md-12"> </div>
                                </div>

                                <div class="bg-white">
                                    <img src="assets/home.jpeg" alt="..." class=" w-25 d-flex mr-3 rounded-circle">
                                </div>
										...
										foreach($mrows1 as $rows1){
											...
											?>
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <?php echo $rows->bus_name." - ".$rows->bus_reg_no." : ".$rows->available.' Seats'; ?>
                                                    </td>
                                                    ...
                                                    <td class="center">
                                                        <?php echo $rows->board_point.' - '.$rows->drop_point; ?>
                                                    </td>
