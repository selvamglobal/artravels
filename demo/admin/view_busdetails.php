...
<head>
    ...
    <title>Bus Information - Art Travels</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <td class="center"><?php echo $rows->bus_name; ?></td>                         
                           <td class="center"><?php echo $rows->bus_reg_no; ?></td>
                          
                           <td class="center"><?php echo $rows->bus_type; ?></td>						   
                           <td class="center"><?php echo $rows->max_seats; ?></td>                         
                         ...
                         <a class="btn btn-sm btn-success show-busgetdetails"  href="add_busdetails.php?id=<?php echo $rows->id; ?>"  data-id="101">
                              <i class="fa fa-fw fa-eye"></i> View / Edit</a>	
                              <a class="btn btn-sm btn-danger" href="delete_bus.php?id=<?php echo $rows->id; ?>" onClick="return doconfirm()">
