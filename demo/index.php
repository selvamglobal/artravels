                ...
                <div class="ptext">
                    <div class="cover-container pb-5 pt-5">
                        <div class="cover-inner container  reveal-top" style="max-width:600px;">
                            ...
                            <h6 class="text-light-yellow"> <strong> Daily trips from Coimbatore, Tirupur to Chennai and from Chennai to Tirupur, Coimbatore </strong></h6>
							...
							?>
                                ...
                                <div class="form-row">
                                    ...
                                    <i class="fa fa-calendar calendar" aria-hidden="true"></i>
                                        ...
                                        <input type="" class="form-control" id="travel_date" name="travel_date" value="<?php echo date("d/m/Y");?>"  placeholder="dd/mm/yyyy" >
                                         </div>
                                    <div class="form-group col-md-6">
                                    <i class="fa fa-calendar calendar" aria-hidden="true"></i>
...
?>
        ...
        <script>
            ...
            $("#btnBook").click(function () {
				if($("#board_point").val()==""){
					alert('Choose From Location!');
				return false;	
				}
				if($("#drop_point").val()==""){
					alert('Choose To Location!');
				return false;	
				}
